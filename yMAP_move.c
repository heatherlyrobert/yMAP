...
char
ymap_horz               (uchar a_major, uchar a_minor)
{
   /*> /+---(locals)-----------+-----+-----+-+/                                          <* 
    *> char        rce         =  -10;                                                   <* 
    *> char        rc          =    0;                                                   <* 
    ...
    *> switch (a_major) {                                                                <* 
    *> case  ' ' :                                                                       <* 
    *>    rc  = yvikeys__map_basic  (YMAP_XAXIS, a_minor, &x_grid, x_gmin, g_gsizex, x_gmax);   <* 
    *>    break;                                                                         <* 
    *> case  'c' :                                                                       <* 
    *>    rc  = yvikeys__map_page   (YMAP_XAXIS, &a_minor);                                     <* 
    *>    if (rc < 0)  break;                                                            <* 
    *> case  'g' :                                                                       <* 
    *>    rc  = yvikeys__map_goto   (YMAP_XAXIS, a_minor, &x_grid, x_qtr, x_bqtr);              <* 
    *>    break;                                                                         <* 
    *> case  'z' :                                                                       <* 
    *>    rc  = yvikeys__map_scroll (YMAP_XAXIS, a_minor, x_qtr, x_gmax);                       <* 
    *>    break;                                                                         <* 
    *> case  'e' :                                                                       <* 
    *>    rc  = yvikeys__map_ends   (YMAP_XAXIS, a_minor, &x_grid, x_qtr, x_gmax);              <* 
    *>    break;                                                                         <* 
    *> }                                                                                 <* 
    *> /+---(check for trouble)--------------+/                                          <* 
...
char
ymap_vert             (uchar a_major, uchar a_minor)
{
   /*> /+---(locals)-----------+-----+-----+-+/                                          <* 
    *> char        rce         =  -10;                                                   <* 
    *> char        rc          =    0;                                                   <* 
    ...
    *> switch (a_major) {                                                                <* 
    *> case  ' ' :                                                                       <* 
    *>    rc  = yvikeys__map_basic  (YMAP_YAXIS, a_minor, &x_grid, x_gmin, g_gsizey, x_gmax);   <* 
    *>    break;                                                                         <* 
    *> case  'c' :                                                                       <* 
    *>    rc  = yvikeys__map_page   (YMAP_YAXIS, &a_minor);                                     <* 
    *>    if (rc < 0)  break;                                                            <* 
    *> case  'g' :                                                                       <* 
    *>    rc  = yvikeys__map_goto   (YMAP_YAXIS, a_minor, &x_grid, x_qtr, x_bqtr);              <* 
    *>    break;                                                                         <* 
    *> case  'z' :                                                                       <* 
    *>    rc  = yvikeys__map_scroll (YMAP_YAXIS, a_minor, x_qtr, x_gmax);                       <* 
    *>    break;                                                                         <* 
    *> case  'e' :                                                                       <* 
    *>    rc  = yvikeys__map_ends   (YMAP_YAXIS, a_minor, &x_grid, x_qtr, x_gmax);              <* 
    *>    break;                                                                         <* 
    *> }                                                                                 <* 
    *> /+---(check for trouble)--------------+/                                          <* 
    *> DEBUG_MAP   yLOG_value   ("rc"        , rc);                                      <* 
